...
## Instalação
- Para iniciar o desenvolvimento com MAUI, é necessário instalar o .NET SDK, o Visual Studio ou Visual Studio Code com o suporte a MAUI e configurar um emulador ou dispositivo físico.
